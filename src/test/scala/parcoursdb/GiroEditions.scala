...
object GiroEditions {
  ...
  def giro1991:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Sala Baganza", finish="Savona", length=223.0)
      _ <- roadStage(start="Savona", finish="Pian del Re", length=182.0)
      _ <- roadStage(start="Savigliano", finish="Sestrière", length=192.0)
  ...
  def giro1992:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Imola", finish="Bassano del Grappa", length=233.0)
      _ <- roadStage(start="Bassano del Grappa", finish="Corvara", length=204.0)
  ...
  def giro1993:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Biella", finish="Milano", length=166.0)
    } yield()
  ...
  def giro1994:StageRaceEdition = {
    ...
    val composition = for {
      ...
      _ <- roadStage(start="Castiglione della Pescaia", finish="Pontedera", length=153.0)
      ...
      _ <- roadStage(start=lesDeuxAlpes, finish="Sestrière", length=121.0)
      _ <- roadStage(start="Turin", finish="Milano", length=198.0)
    } yield()
  ...
  def giro1995:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Stradella", finish="Sanctuario di Vicoforte", length=221.0)
      _ <- roadStage(start="Mondovi", finish="Pontechianale", length=130.0)
      _ <- roadStage(start=Location("Briançon")(France), finish="Gressoney-Saint-Jean", length=208.0)
      _ <- roadStage(start="Pont-Saint-Martin", finish="Luino", length=190.0)
      _ <- roadStage(start="Luino", finish="Milano", length=148.0)
    } yield()
  ...
  def giro1996:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Sanctuario di Vicoforte", finish=Location("Briançon")(France), length=202.0)
      _ <- roadStage(start=Location("Briançon")(France), finish="Aosta", length=235.0)
      ...
      _ <- roadStage(start="Sondrio", finish="Milano", length=176.0)
    } yield()
  ...
  def giro1997:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Boario Terme", finish="Milano", length=165.0)
    } yield()
  ...
  def giro1999:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Darfo Boario Terme", finish="Milano", length=170.0)
    } yield()
  ...
  def giro2000:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Saluzzo", finish=Location("Briançon")(France), length=176.0)
      _ <- individualTimeTrial(briancon, sestriere, 32.0)
      _ <- roadStage(start="Turin", finish="Milano", length=189.0)
    } yield()
  ...
  def giro2001:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Arona", finish="Milano", length=125.0)
    } yield()
  ...
  def giro2002:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Cantu", finish="Milano", length=141.0)
    } yield()
  ...
  def giro2018:StageRaceEdition = {
    ...
    val composition = for {
      ...
      _ <- c3("Sestrière", height=2035, summitKM=138.4)
