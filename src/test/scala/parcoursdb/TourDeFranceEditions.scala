...
object TourDeFranceEditions {
  ...
  val forest          = Location("Forest")(Belgium)
  val marcheEnFamenne = Location("Marche-en-Famenne")(Belgium)
  val dinant          = Location("Dinant")(Belgium)
  val brussels        = Location("Brussels")(Belgium)
  val rochefort       = Location("Rochefort")(Belgium)
  val spa             = Location("Spa")(Belgium)
  val liege           = Location("Liege")(Belgium)
  val circuitZolder   = Location("Circuit Zolder")(Belgium)
  val hasselt         = Location("Hasselt")(Belgium)
  val beringen        = Location("Beringen")(Belgium)
  val beauraing       = Location("Beauraing")(Belgium)
  val mouscron        = Location("Mouscron")(Belgium)
  val charleroi       = Location("Charleroi")(Belgium)
  val huy             = Location("Huy")(Belgium)
  val seraing         = Location("Seraing")(Belgium)
  val antwerp         = Location("Antwerp")(Belgium)
  val namur           = Location("Namur")(Belgium)
  val waterloo        = Location("Waterloo")(Belgium)
  val ghent           = Location("Ghent")(Belgium)
  val waregem         = Location("Waregem")(Belgium)
  val wanze           = Location("Wanze")(Belgium)
  val vise            = Location("Vise")(Belgium)
  val tournai         = Location("Tournai")(Belgium)
  val ypres           = Location("Ypres")(Belgium)

  // Dutch locations
  val leiden         = Location("Leiden")(Netherlands)
  val sintWillebrord = Location("Sint Willebrord")(Netherlands)
  val valkenburg     = Location("Valkenburg")(Netherlands)
  val hertogenbosch  = Location("'s-Hertogenbosch")(Netherlands)
  val rotterdam      = Location("Rotterdam")(Netherlands)
  val utrecht        = Location("Utrecht")(Netherlands)
  val zeeland        = Location("Zeeland")(Netherlands)
  ...
  val felsberg             = Location("Felsberg")(WestGermany)
  val saarlouis            = Location("Saarlouis")(WestGermany)
  val freiburgWestGermany  = Location("Freiburg")(WestGermany)
  ...
  // German locations
  val freiburg     = Location("Freiburg")(Germany)
  ...
  val bern         = Location("Bern")(Switzerland)
  val mohin        = Location("Mohin")(Switzerland)
  val cransMontana = Location("Crans-Montana")(Switzerland)
  val geneva       = Location("Geneva")(Switzerland)
  val fribourg     = Location("Fribourg")(Switzerland)
  val neuchatel    = Location("Neuchatel")(Switzerland)
  val laChaux      = Location("La Chaux-de-Fonds")(Switzerland)
  val lausanne     = Location("Lausanne")(Switzerland)
  val verbier      = Location("Verbier")(Switzerland)
  val martigny     = Location("Martigny")(Switzerland)
  val finhaut      = Location("Finhaut-Emosson")(Switzerland)

  // English towns and cities
  val dover      = Location("Dover")(UnitedKingdom)
  val brighton   = Location("Brighton")(UnitedKingdom)
  val portsmouth = Location("Portsmouth")(UnitedKingdom)
  val london     = Location("London")(UnitedKingdom)
  val canterbury = Location("Canterbury")(UnitedKingdom)
  val leeds      = Location("Leeds")(UnitedKingdom)
  ...
  val dublin      = Location("Dublin")(Ireland)
  val enniscorthy = Location("Enniscorthy")(Ireland)

  // Italian towns
  val sestriere   = Location("Sestriere")(Italy)
  val turin       = Location("Turin")(Italy)
  val pratoNevoso = Location("Prato Nevoso")(Italy)
  val cuneo       = Location("Cuneo")(Italy)
  val pinerolo    = Location("Pinerolo")(Italy)
  ...
  def tdf1970:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Limoges", finish="La Rochelle", length=224.0)
      _ <- roadStage(start="La Rochelle", finish="Angers", length=200.0)
      _ <- enableSplitStages
      ...
      _ <- disableSplitStages
      _ <- roadStage(start="Amiens", finish="Valanciennes", length=135.5)
      _ <- enableSplitStages
      _ <- roadStage(start="Valanciennes", finish=forest, length=120.0)
      ...
      _ <- enableSplitStages
      _ <- individualTimeTrial(start="Divonne-les-Bains", finish="Divonne-les-Bains", length=8.8)
      ...
      _ <- roadStage(start="Bagneres-de-Bigorre", finish="Mourenx", length=185.5)
      _ <- enableSplitStages
      _ <- roadStage(start="Mourenx", finish="Bordeaux", length=223.5)
      _ <- individualTimeTrial(start="Bordeaux", finish="Bordeaux", length=8.2)
      _ <- disableSplitStages
      _ <- roadStage(start="Ruffex", finish="Tours", length=191.5)
      _ <- roadStage(start="Tours", finish="Versailles", length=238.5)
      _ <- individualTimeTrial(start="Versailles", finish="Paris", length=54.0)
    } yield()
  ...
  def tdf1971:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start=basel, finish=freiburgWestGermany, length=90.0)
      _ <- roadStage(start=freiburgWestGermany, finish="Mulhouse", length=74.5)
      _ <- disableSplitStages
      ...
      _ <- disableSplitStages
      _ <- restDay("Le Touquet")
      _ <- roadStage(start="Rungis", finish="Nevers", length=257.5)
      _ <- roadStage(start="Nevers", finish="Puy de Dome", length=221.0)
      _ <- roadStage(start="Clermont-Ferrand", finish="Saint-Etienne", length=153.0)
      _ <- roadStage(start="Saint-Etienne", finish="Grenoble", length=188.5)
      _ <- roadStage(start="Grenoble", finish="Orcieres", length=134.0)
      _ <- restDay("Orcieres")
      _ <- roadStage(start="Orcieres", finish="Marseille", length=251.0)
      _ <- criterium("Albi", length=16.3)
      _ <- roadStage(start="Revel", finish="Luchon", length=214.5)
      _ <- roadStage(start="Luchon", finish="Superbagneres", length=19.6)
      _ <- enableSplitStages
      ...
      _ <- individualTimeTrial(start="Versailles", finish="Paris", length=53.8)
    } yield()
  ...
  def tdf1978:StageRaceEdition = {
    val composition = for {
      ...
      _ <- disableSplitStages
      _ <- roadStage(start=brussels, finish="Saint-Amand-les-Eaux", length=199.0)
      _ <- roadStage(start="Saint-Amand-les-Eaux", finish="Saint-Germain-en-Laye", length=244.0)
      _ <- teamTimeTrial(start="Evreux", finish="Caen", length=153.0)
      _ <- roadStage(start="Caen", finish="Maze-Montgeoffroy", length=244.0)
      _ <- roadStage(start="Maze-Montgeoffroy", finish="Poitiers", length=162.0)
      _ <- roadStage(start="Poitiers", finish="Bordeaux", length=242.0)
      _ <- individualTimeTrial(start="Saint-Emilion", finish="Sainte-Foy-la-Grande", length=59.0)
      ...
      _ <- individualTimeTrial(start="Besse-en-Chandesse", finish="Puy de Dome", length=52.0)
      _ <- roadStage(start="Saint-Dier-d'Auvergne", finish="Saint-Etienne", length=196.0)
      _ <- roadStage(start="Saint-Etienne", finish="Alpe d'Huez", length=241.0)
      _ <- restDay("Alpe d'Huez")
      ...
      _ <- individualTimeTrial(start="Metz", finish="Nancy", length=72.0)
      _ <- roadStage(start="Epernay", finish="Senlis", length=207.0)
      _ <- roadStage(start="Saint Germain en Laye", finish="Paris", length=162.0)
    } yield()
  ...
  def tdf1979:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Luchon", finish="Superbagneres", length=24.0)
      _ <- roadStage(start="Luchon", finish="Pau", length=180.0)
      _ <- teamTimeTrial(start="Captieux", finish="Bordeaux", length=87.0)
      _ <- roadStage(start="Neuville-de-Poitou", finish="Angers", length=145.0)
      _ <- roadStage(start="Angers", finish="Saint-Brieuc", length=239.0)
      _ <- roadStage(start="Saint-Hilaire-du-Harcouet", finish="Deauville", length=158.0)
      _ <- teamTimeTrial(start="Deauville", finish="Le Havre", length=90.0)
      _ <- roadStage(start="Amiens", finish="Roubaix", length=201.0)
      _ <- roadStage(start="Roubaix", finish=brussels, length=124.0)
      _ <- individualTimeTrial(start=brussels, finish=brussels, length=33.0)
      _ <- roadStage(start=rochefort, finish="Metz", length=193.0)
      _ <- roadStage(start="Metz", finish="Ballon d'Alsace", length=202.0)
      _ <- roadStage(start="Belfort", finish="Evian-les-Bains", length=248.0)
      _ <- individualTimeTrial(start="Evian-les-Bains", finish="Morzine Avoriaz", length=54.0)
      _ <- roadStage(start="Morzine Avoriaz", finish="Les Menuires", length=201.0)
      _ <- restDay("Les Menuires")
      _ <- roadStage(start="Les Menuires", finish="Alpe d'Huez", length=167.0)
      _ <- criterium("Alpe d'Huez", length=119.0)
      _ <- roadStage(start="Alpe d'Huez", finish="Saint-Priest", length=162.0)
      _ <- roadStage(start="Saint-Priest", finish="Dijon", length=240.0)
      _ <- individualTimeTrial(start="Dijon", finish="Dijon", length=49.0)
      _ <- roadStage(start="Dijon", finish="Auxerre", length=189.0)
      _ <- roadStage(start="Auxerre", finish="Nogent-sur-Marne", length=205.0)
      _ <- roadStage(start="Le Perreux-sur-Marne", finish="Paris", length=180.0)
    } yield()
  ...
  def tdf1980:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Voreppe", finish="Saint-Etienne", length=140.0)
      _ <- individualTimeTrial(start="Saint-Etienne", finish="Saint-Etienne", length=34.0)
  ...
  def tdf1981:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Nice", finish="Nice", length=40.0)
      _ <- disableSplitStages
      ...
      _ <- individualTimeTrial(start="Nay", finish="Pau", length=27.0)
      ...
      _ <- individualTimeTrial(start="Mulhouse", finish="Mulhouse", length=38.0)
      ...
      _ <- individualTimeTrial(start="Saint-Priest", finish="Saint-Priest", length=46.0)
  ...
  def tdf1982:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Orchies", finish="Fontaine-au-Pire", length=73.0)
      ...
      _ <- individualTimeTrial(start="Valence d'Agen", finish="Valence d'Agen", length=57.0)
      ...
      _ <- restDay("Martigues")
      _ <- individualTimeTrial(start="Martigues", finish="Martigues", length=33.0)
      _ <- roadStage(start="Manosque", finish="Orcieres-Merlette", length=208.0)
      _ <- roadStage(start="Orcieres-Merlette", finish="Alpe d'Huez", length=123.0)
      ...
      _ <- individualTimeTrial(start="Saint-Priest", finish="Saint-Priest", length=48.0)
  ...
  def tdf1983:StageRaceEdition = {
    val composition = for {
      _ <- prologue("Fontenay-sous-Bois", 6.0)
      ...
      _ <- individualTimeTrial(start="Chateaubriant", finish="Nantes", length=58.0)
      _ <- roadStage(start="Nantes", finish="Ile d'Oleron", length=216.0)
      _ <- roadStage(start="La Rochelle", finish="Bordeaux", length=222.0)
      ...
      _ <- individualTimeTrial(start="Clermont Ferrand", finish="Puy de Dome", length=16.0)
      _ <- roadStage(start="Issoire", finish="Saint-Etienne", length=144.0)
      ...
      _ <- individualTimeTrial(start="Morzine", finish="Avoriaz", length=15.0)
      _ <- roadStage(start="Morzine", finish="Dijon", length=291.0)
      _ <- individualTimeTrial(start="Dijon", finish="Dijon", length=50.0)
  ...
  def tdf1984:StageRaceEdition = {
    val composition = for {
      _ <- prologue("Montreuil", "Noisy-le-Sec", 5.0)
      ...
      _ <- individualTimeTrial(start="Alencon", finish="Le Mans", length=67.0)
      ...
      _ <- restDay("Grenoble")
      _ <- individualTimeTrial(start="Les Echelles", finish="La Ruchere", length=22.0)
      ...
      _ <- individualTimeTrial(start="Villie-Morgon", finish="Villefranche-sur-Saone", length=51.0)
    } yield()
  ...
  def tdf1985:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Sarrebourg", finish="Strasbourg", length=75.0)
      ...
      _ <- individualTimeTrial(start="Villard-de-Lans", finish="Villard-de-Lans", length=32.0)
      _ <- restDay("Villard-de-Lans")
      _ <- roadStage(start="Autrans", finish="Saint-Etienne", length=179.0)
      _ <- roadStage(start="Saint-Etienne", finish="Aurillac", length=238.0)
      ...
      _ <- individualTimeTrial(start="Lac de Vassiviere", finish="Lac de Vassiviere", length=46.0)
  ...
  def tdf1986:StageRaceEdition = {
    val composition = for {
      _ <- prologue("Boulogne-Billancourt", 4.6)
      _ <- morningStage
      _ <- roadStage(start="Nanterre", finish="Sceaux", length=85.0)
      _ <- afternoonStage
      _ <- teamTimeTrial(start="Meudon", finish="Saint-Quentin-en-Yvelines", length=56.0)
      ...
      _ <- individualTimeTrial(start="Nantes", finish="Nantes", length=61.5)
      ...
      _ <- roadStage(start="Pau", finish="Superbagneres", length=186.0)
      _ <- roadStage(start="Superbagneres", finish="Blagnac", length=154.0)
      ...
      _ <- roadStage(start="Briancon", finish="Alpe d'Huez", length=162.5)
      _ <- restDay("Alpe d'Huez")
      _ <- roadStage(start="Villard-de-Lans", finish="Saint-Etienne", length=179.5)
      _ <- individualTimeTrial(start="Saint-Etienne", finish="Saint-Etienne", length=58.0)
      _ <- roadStage(start="Saint-Etienne", finish="Puy de Dome", length=190.0)
  ...
  def tdf1987:StageRaceEdition = {
    val composition = for {
      ...
      _ <- afternoonStage
      _ <- roadStage(start=pforzheimWestGermany, finish="Strasbourg", length=112.5)
      ...
      _ <- individualTimeTrial(start="Saumur", finish="Futuroscope", length=87.5)
      ...
      _ <- restDay("Avignon")
      _ <- individualTimeTrial(start="Carpentras", finish="Mont Ventoux", length=36.5)
  ...
  def tdf1988:StageRaceEdition = {
    val composition = for {
      _ <- prologue("Pornichet", "La Baule", 1.0)
      _ <- morningStage
      _ <- roadStage(start="Pontchateau", finish="Machecoul", length=91.5)
      _ <- afternoonStage
      _ <- teamTimeTrial(start="La Haie-Fouassiere", finish="Ancenis", length=48.0)
      ...
      _ <- individualTimeTrial(start="Lievin", finish="Wasquehal", length=52.0)
      ...
      _ <- individualTimeTrial(start="Grenoble", finish="Villard-de-Lans", length=38.0)
      _ <- restDay("Blagnac")
      ...
      _ <- roadStage(start="Limoges", finish="Puy de Dome", length=188.0)
      _ <- roadStage(start="Clermont Ferrand", finish="Chalon sur Saone", length=233.5)
      _ <- individualTimeTrial(start="Santennay", finish="Santennay", length=48.0)
  ...
  def tdf1992:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Pau", finish="Bordeaux", length=210.0)
      _ <- teamTimeTrial(start="Libourne", finish="Libourne", length=63.5)
      ...
      _ <- roadStage(start="Le Bourg-d'Oisans", finish="Saint-Etienne", length=198.0)
      _ <- roadStage(start="Saint-Etienne", finish="La Bourboule", length=212.0)
      _ <- roadStage(start="La Bourboule", finish="Montlucon", length=189.0)
      _ <- roadStage(start="Montlucon", finish="Tours", length=212.0)
      _ <- individualTimeTrial(start="Tours", finish="Blois", length=64.0)
  ...
  def tdf1993:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Lac de Madine", finish="Lac de Madine", length=59.0)
      _ <- restDay("Villard-de-Lans")
      ...
      _ <- individualTimeTrial(start="Bretigny-sur-Orge", finish="Montlhery", length=48.0)
  ...
  def tdf1994:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Perigueux", finish="Bergerac", length=64.0)
      ...
      _ <- individualTimeTrial(start="Cluses", finish="Avoriaz", length=47.5)
  ...
  def tdf1995:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start=huy, finish=seraing, length=54.0)
      _ <- restDay("Le Grand-Bornand")
      ...
      _ <- roadStage(start="Le Bourg-d'Oisans", finish="Saint-Etienne", length=199.0)
      _ <- roadStage(start="Saint-Etienne", finish="Mende", length=222.5)
      ...
      _ <- individualTimeTrial(start="Lac de Vassiviere", finish="Lac de Vassiviere", length=46.5)
  ...
  def tdf1996:StageRaceEdition = {
    val composition = for {
      _ <- prologue(hertogenbosch, 9.4)
      _ <- criterium(hertogenbosch, length=209.0)
      _ <- roadStage(start=hertogenbosch, finish="Wasquehal", length=247.5)
      ...
      _ <- individualTimeTrial(start="Bourg-Saint-Maurice", finish="Val d'Isere", length=30.5)
  ...
  def tdf1997:StageRaceEdition = {
    val composition = for {
      ...
      _ <- restDay("Saint-Etienne")
      _ <- individualTimeTrial(start="Saint-Etienne", finish="Saint-Etienne", length=55.0)
      _ <- roadStage(start="Saint-Etienne", finish="Alpe d'Huez", length=203.5)
      ...
      _ <- individualTimeTrial(start="Disneyland", finish="Disneyland Paris", length=63.0)
  ...
  def tdf1998:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Meyrignac-l'Eglise", finish="Correze", length=58.0)
      ...
      _ <- roadStage(start=laChaux, finish="Autun", length=242.0)
  ...
  def tdf1999:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Metz", finish="Metz", length=56.5)
      _ <- restDay("Le Grand-Bornand")
      ...
      _ <- roadStage(start="Le Bourg-d'Oisans", finish="Saint-Etienne", length=198.5)
      ...
      _ <- individualTimeTrial(start="Futuroscope", finish="Futuroscope", length=57.0)
  ...
  def tdf2000:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Bagneres-de-Bigorre", finish="Revel", length=218.5)
      _ <- restDay("Provence")
      _ <- roadStage(start="Carpentras", finish="Mont Ventoux", length=149.0)
      _ <- roadStage(start="Avignon", finish="Draguignan", length=185.5)
      _ <- roadStage(start="Briancon", finish="Courchevel", length=173.5)
      ...
      _ <- individualTimeTrial(start=freiburg, finish="Mulhouse", length=58.5)
      _ <- roadStage(start="Belfort", finish="Troyes", length=254.5)
      _ <- criterium("Paris", length=138.0)
    } yield()
  ...
  def tdf2001:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Verdun", finish="Bar-le-Duc", length=67.0)
      ...
      _ <- individualTimeTrial(start="Grenoble", finish="Chamrousse", length=32.0)
      _ <- restDay("Perpignan")
      ...
      _ <- individualTimeTrial(start="Montlucon", finish="Saint-Amand-Montrond", length=61.0)
  ...
  def tdf2002:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Epernay", finish="Chateau-Thierry", length=67.5)
      ...
      _ <- individualTimeTrial(start="Lanester", finish="Lorient", length=52.0)
      _ <- restDay("Bordeaux")
      ...
      _ <- individualTimeTrial(start="Regnie-Durette", finish="Macon", length=50.0)
  ...
  def tdf2003:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Joinville", finish="Saint-Dizier", length=69.0)
      ...
      _ <- individualTimeTrial(start="Gaillac", finish="Cap Decouverte", length=47.0)
      ...
      _ <- roadStage(start="Bagneres-de-Bigorre", finish="Luz Ardiden", length=159.5)
      _ <- restDay("Pau")
      ...
      _ <- individualTimeTrial(start="Pornic", finish="Nantes", length=49.0)
  ...
  def tdf2004:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Le Bourg-d'Oisans", finish="Alpe d'Huez", length=15.5)
      ...
      _ <- individualTimeTrial(start="Besancon", finish="Besancon", length=55.0)
  ...
  def tdf2005:StageRaceEdition = {
    val composition = for {
      _ <- individualTimeTrial(start="Fromentine", finish="Noirmoutier-en-L'Ile", length=19.0)
      ...
      _ <- restDay("Grenoble")
      _ <- roadStage(start="Courchevel", finish="Briancon", length=173.0)
      _ <- roadStage(start="Briancon", finish="Digne-les-Bains", length=187.0)
      ...
      _ <- individualTimeTrial(start="Saint-Etienne", finish="Saint-Etienne", length=55.5)
  ...
  def tdf2006:StageRaceEdition = {
    val composition = for {
      ...
      _ <- criterium("Strasbourg", length=184.5)
      ...
      _ <- individualTimeTrial(start="Saint Gregoire", finish="Rennes", length=52.0)
      ...
      _ <- individualTimeTrial(start="Le Creusot", finish="Montceau-les-Mines", length=57.0)
  ...
  def tdf2007:StageRaceEdition = {
    val composition = for {
      ...
      _ <- restDay("Tignes")
      _ <- roadStage(start="Val-d'Isere", finish="Briancon", length=159.5)
      ...
      _ <- individualTimeTrial(start="Albi", finish="Albi", length=54.0)
      ...
      _ <- individualTimeTrial(start="Cognac", finish="Angouleme", length=55.5)
  ...
  def tdf2008:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Cholet", finish="Cholet", length=29.5)
      ...
      _ <- roadStage(start="Toulouse", finish="Bagneres-de-Bigorre", length=224.0)
      ...
      _ <- roadStage(start="Bourg-d'Oisans", finish="Saint-Etienne", length=196.5)
      _ <- roadStage(start="Roanne", finish="Montlucon", length=165.5)
      _ <- individualTimeTrial(start="Cerilly", finish="Saint-Amand-Montrond", length=53.0)
  ...
  def tdf2009:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Montpellier", finish="Montpellier", length=39.0)
      ...
      _ <- individualTimeTrial(start="Annecy", finish="Annecy", length=40.5)
  ...
  def tdf2010:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Bordeaux", finish="Pauillac", length=52.0)
  ...
  def tdf2011:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Les Essarts", finish="Les Essarts", length=23.0)
      ...
      _ <- individualTimeTrial(start="Grenoble", finish="Grenoble", length=42.5)
  ...
  def tdf2012:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Arc-et-Senans", finish="Besancon", length=41.5)
      _ <- restDay("Macon")
  ...
  def tdf2013:StageRaceEdition = {
    val composition = for {
      ...
      _ <- teamTimeTrial(start="Nice", finish="Nice", length=25.0)
      ...
      _ <- roadStage(start="Saint-Girons", finish="Bagneres-de-Bigorre", length=168.5)
      _ <- restDay("Saint-Nazaire")
      _ <- roadStage(start="Saint-Gildas-des-Bois", finish="Saint-Malo", length=197.0)
      _ <- individualTimeTrial(start="Avranches", finish="Mont Saint-Michel", length=33.0)
      ...
      _ <- individualTimeTrial(start="Embrun", finish="Chorges", length=32.0)
  ...
  def tdf2014:StageRaceEdition = {
    val composition = for {
      ...
      _ <- roadStage(start="Bourg-en-Bresse", finish="Saint-Etienne", length=185.5)
      _ <- roadStage(start="Saint-Etienne", finish="Chamrousse", length=197.5)
      ...
      _ <- individualTimeTrial(start="Bergerac", finish="Perigueux", length=54.0)
  ...
  def tdf2016:StageRaceEdition = {
    val composition = for {
      ...
      _ <- individualTimeTrial(start="Bourg-Saint-Andeol", finish="La Caverne du Pont-d'Arc", length=37.5)
      ...
      _ <- individualTimeTrial(start="Sallanches", finish="Megeve", length=17.0)
