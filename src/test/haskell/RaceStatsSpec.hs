...
matchSummary g@(Giro _)
  ...
  | year `elem` [1955,1961,1962,1963,2003] ++ [2006 .. 2019] = "21 stages"
...
matchSummary tdf@(TourDeFrance _)
  ...
  | year `elem` [1968]                                                  = "22 stages + Prologue including 3 split stages"
  ...
  | year `elem` [1936]                                                  = "22 stages including 5 split stages"
  | year `elem` [1933,1952]                                             = "23 stages"
  | year `elem` [1986]                                                  = "23 stages + Prologue"
  | year `elem` [1976]                                                  = "23 stages + Prologue including 3 split stages"
  ...
  | year `elem` [1937]                                                  = "23 stages including 8 split stages"
  | year `elem` [1927,1931,1951,1958]                                   = "24 stages"
  | year `elem` [1938]                                                  = "24 stages including 5 split stages"
