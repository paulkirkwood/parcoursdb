...
matchSummitFinishes g@(Giro _)
  | year `elem` [1936,1937,1938,1948,1953,1955,1956,1957,1961,1965,1971,1977,1980,1981,1984,1987,1988,1993,1997,1998,2001,2004,2013] = 1
  | year `elem` [1939,1951,1959,1960,1973,1974,1975,1978,1982,1989,1992,2006,2014,2017] = 2
  | year `elem` [1954,1962,1967,1968,1990,1991,1994,1996,1999,2003,2005,2007,2008,2016] = 3
  | year `elem` [1972,2000,2011,2012,2019] = 4
  | year `elem` [2009,2010,2015] = 5
  | year == 2018 = 6
  | otherwise = 0
  where (year,_,_) = startDate g
